          ...
          submenu: [
            {
              label: 'Home Page',
              click: (): void => {
                shell.openExternal('https://github.com/iluminar-yi/aie#readme');
              },
            },
            {
              label: 'Bugs and Issues',
              click: (): void => {
                shell.openExternal('https://github.com/iluminar-yi/aie/issues');
              },
            },
            {
              label: 'Latest Releases',
              click: (): void => {
                shell.openExternal('https://github.com/iluminar-yi/aie/releases');
              },
            },
          ],
        },
